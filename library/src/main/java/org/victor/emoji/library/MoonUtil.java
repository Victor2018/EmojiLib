...
public class MoonUtil {
     ...
     * @return
     */
    public static String getStickerPath(String stickerCategoryName, String stickerName) {
        return String.format("file:///android_asset/sticker/%s/%s",stickerCategoryName,stickerName);
    }
}
